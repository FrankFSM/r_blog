              ...
              <form action="/passport/signin" method="POST" id="login-form">
                  ...
                  <input type="password" class="form-control" placeholder="请输入密码" name="password" required=""/>
                                ...
                                <#if enableKaptcha?exists && enableKaptcha>
                                    <div class="form-group col-xs-6" style="padding-left: 0px;">
                                      <img alt="点击获取验证码" id="img-kaptcha" src="/getKaptcha"
                                           style="cursor:pointer;height: 34px;width: 180px;">
                                    </div>
                                    <div class="form-group col-xs-6">
                                      <span><input type="text" class="form-control" placeholder="验证码" id="kaptcha"
                                                   name="kaptcha"></span>
                                    </div>
                                </#if>
                ...
                <div class="separator">
                  ...
                  <div>
                    ...
                    <p>Copyright&copy;2016-${.now?string("yyyy")} <a href="${config.siteUrl}"
                                                                     target="_blank">${config.authorName}</a> ·
                      Powered by <a href="${config.github}" title="${config.homeDesc}"
                                    target="_blank"><strong>${config.siteName}</strong></a>.
